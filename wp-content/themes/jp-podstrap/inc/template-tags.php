...
if ( ! function_exists( 'jp_podstrap_content_nav' ) ) :
/**
 ...
 * @return	void
 */
function jp_podstrap_content_nav() {
...
if ( ! function_exists( 'jp_podstrap_comment_nav' ) ) :
/**
...
if ( ! function_exists( 'jp_podstrap_posted_on' ) ) :
/**
...
if ( ! function_exists( 'jp_podstrap_link_pages' ) ) :
/**
 ...
 * @return	string
 */
function jp_podstrap_link_pages( $args = array() ) {
	...
	$r = apply_filters( 'jp_podstrap_link_pages_args', $r );
	extract( $r, EXTR_SKIP );
...
if ( ! function_exists( 'jp_podstrap_navbar_searchform' ) ) :
/**
...
if ( ! function_exists( 'jp_podstrap_navbar_class' ) ) :
/**
 ...
 * @return	void
 */
function jp_podstrap_navbar_class() {
	$classes	=	array( 'navbar' );

	if ( 'static' != jp_podstrap_options()->navbar_position )
		$classes[]	=	jp_podstrap_options()->navbar_position;
	
	if ( jp_podstrap_options()->navbar_inverse )
		$classes[]	=	'navbar-inverse';
	
	apply_filters( 'jp_podstrap_navbar_classes', $classes );
...
if ( ! function_exists( 'jp_podstrap_comments_link' ) ) :
/**
 ...
 * @return	void
 */
function jp_podstrap_comments_link( $zero = false, $one = false, $more = false, $css_class = '', $none = false ) {
	...
	echo apply_filters( 'jp_podstrap_comments_link', $link, $zero, $one, $more, $css_class, $none );
}
endif;
