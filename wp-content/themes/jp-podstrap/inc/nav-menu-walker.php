...
class jp_podstrap_Nav_Walker extends Walker_Nav_Menu {
 ...
 * @return	array
 */
function jp_podstrap_nav_menu_css_class( $classes ) {
	if ( in_array('current-menu-item', $classes ) OR in_array( 'current-menu-ancestor', $classes ) )
		$classes[]	=	'active';

	return $classes;
}
add_filter( 'nav_menu_css_class', 'jp_podstrap_nav_menu_css_class' );
